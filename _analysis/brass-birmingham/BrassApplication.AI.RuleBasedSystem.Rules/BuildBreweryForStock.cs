...
internal class BuildBreweryForStock : BaseRule
{
	public BuildBreweryForStock()
	{
		base.Id = RuleId.BuildBreweryForStock;
	...
	public override bool IsApplicable(BrassApplicationGame brassApplicationGame)
	{
		...
		currentPlayer.Mat.GetFirstBuildingOfType(BuildingType.Brewery);
		bool flag = false;
		...
		if (!flag && brassApplicationGame.Game.GameProgressInformation.CurrentGameEra == GameEra.RailEra && brassApplicationGame.Game.GameProgressInformation.CurrentRoundNumber < 2)
		{
