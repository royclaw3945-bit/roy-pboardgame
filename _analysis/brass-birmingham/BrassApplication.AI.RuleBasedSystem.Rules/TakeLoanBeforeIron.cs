...
internal class TakeLoanBeforeIron : BaseRule
{
	public TakeLoanBeforeIron()
	{
		base.Id = RuleId.TakeLoanBeforeIron;
	...
	public override bool IsApplicable(BrassApplicationGame brassApplicationGame)
	{
		...
		if (BuildIronForHighDemand.BestSlot(brassApplicationGame) != null && BuildIronForHighDemand.GetPriorityStatic(brassApplicationGame) == 2500 && flag && brassApplicationGame.Game.TurnFlow.GetRemainingActionsCount() >= 2 && currentPlayer.Money < 8)
		{
